...
const MembershipButton = forwardRef(
  ({ currentUserIsMember, handleClose, handleLeave, handleJoin }, ref) => {
    const classes = useStyles()

    return currentUserIsMember ? (
      <MenuItem onClick={handleClose} className={classes.menuItem} ref={ref}>
        <Box onClick={handleLeave}>Leave Club</Box>
      </MenuItem>
    ) : (
      <MenuItem onClick={handleClose} className={classes.menuItem} ref={ref}>
        <Box onClick={handleJoin}>Join Club</Box>
      </MenuItem>
    )
  }
)
  ...
  return currentUserIsMod ? (
    <>
      <MenuItem onClick={handleClose} className={classes.menuItem}>
        <Box onClick={toggleModMembers}>Current members</Box>
      </MenuItem>
